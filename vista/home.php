...
<header>
  ...
  <div class="container">
        ...
        <div class="enlace">
            <h3><a href=" <?php echo $_SERVER['PHP_SELF']."?accion=libros_disponibles"; ?>">Listar libros Disponibles</a><h3>
        </div>

        <div class="enlace">
            <h3><a href=" <?php echo $_SERVER['PHP_SELF']."?accion=ir_prestamo"; ?>">Solicitar el préstamo de un libro</a><h3>
        </div>
        <div class="enlace">
            <h3><a href=" <?php echo $_SERVER['PHP_SELF']."?accion=ir_devolver"; ?>">Devolver un libro</a><h3>
        </div>
        <div class="enlace">
